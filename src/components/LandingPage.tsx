...
import { Smartphone, QrCode, Key, CheckCircle, ExternalLink, RefreshCw, Send, AlertCircle, Upload, Copy, Check } from 'lucide-react';
              ...
              <div className="space-y-6">
                ...
                {method === 'pairing' && (
                  ...
                  <div className="space-y-6 animate-fade-in">
                    ...
                    {pairingCode && (
                      <div className="p-6 bg-zinc-900/60 border border-zinc-800 rounded-2xl text-center space-y-4 shadow-lg animate-fade-in">
                        <span className="text-xs font-semibold tracking-wider uppercase text-zinc-500">Your Pairing Code</span>
                        
                        <div className="flex items-center justify-center gap-3">
                          <div className="text-3xl sm:text-4xl font-black font-mono tracking-widest text-emerald-400 bg-black/40 px-4 py-2 rounded-xl border border-emerald-500/20">
                            {pairingCode}
                          </div>
                          <button
                            type="button"
                            onClick={handleCopyCode}
                            className="p-3 bg-zinc-800 hover:bg-zinc-700 text-zinc-200 border border-zinc-700 hover:border-emerald-500/50 rounded-xl transition-all flex items-center justify-center shrink-0 active:scale-95 cursor-pointer shadow-sm"
                            title="Copy pairing code to clipboard"
                          >
                            {copiedCode ? (
                              <Check className="w-5 h-5 text-emerald-400 animate-in zoom-in-50" />
                            ) : (
                        ...
                        <div className="flex justify-center pt-1">
                          <button
                            type="button"
                            onClick={handleCopyCode}
                            className={`inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-bold transition-all shadow-md active:scale-95 cursor-pointer border ${
                              copiedCode
                        ...
                        <div className="bg-zinc-950/60 p-3.5 rounded-xl border border-zinc-800/80 text-left space-y-2 mt-2">
                          <p className="text-xs font-semibold text-zinc-300">How to link on your WhatsApp:</p>
                          <ol className="text-xs text-zinc-400 space-y-1.5 list-decimal list-inside leading-relaxed">
                            <li>Open <strong className="text-zinc-200">WhatsApp</strong> on your mobile phone.</li>
                            <li>Go to <strong className="text-zinc-200">Settings</strong> (or 3 dots menu) → <strong className="text-zinc-200">Linked Devices</strong>.</li>
                            <li>Tap <strong className="text-zinc-200">Link a Device</strong>.</li>
                            <li>Tap <strong className="text-emerald-400 font-medium">Link with phone number instead</strong> at the bottom.</li>
